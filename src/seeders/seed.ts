...
import {User, prisma } from "../utils/prisma.server";
import { userPick } from 'src/utils/format.server';
...
const corporationValues= [
    {name: "clinica sar carlos",ruc: "111111",fullDescription: "clinica san carlos la mejor de la ciudad"},
    {name: "clinica sar yefry",ruc: "2222222222",fullDescription: "yefry el mejor cirujado de la clinica"},
    {name: "clinica santamaria",ruc: "3333333",fullDescription: "clinica santamaria la mejor de la ciudad"},
    {name: "clinica sar juan",ruc: "4444444",fullDescription: "clinica san juan la mejor de la ciudad"},
  ]
const userValues:userPick[]=[
  // {documentNumber:"123214",password:"mimamamedijo",role:"DOCTOR",corporationId:2}
  {documentNumber: "454545454",password: "mypassword",role: "ADMIN",corporationId: 1},
  {documentNumber: "12121212",password: "1234",role: "ADMIN",corporationId: 2},
  {documentNumber: "89898989",password: "mypassword",role: "ADMIN",corporationId: 1},
  {documentNumber: "70007070",password: "mypassword",role: "ADMIN",corporationId: 1},
]
const profileValues=[
    {
      firstName: "wily",
